...
class ProfilePage extends StatelessWidget {
        ...
        if (state is ProfileLoaded) {
          return RefreshIndicator(
            ...
            onRefresh: () async {
              ...
              context.read<ProfileBloc>().add(const LoadHistoryEvent());
            },
  ...
  Widget _buildDivider() =>
      Container(width: 1, height: 40, color: const Color(0xFF2A2A4E));
  ...
  Widget _buildEmptyHistory(BuildContext context) => Container(
    ...
    child: Column(
      children: [
        const Icon(Icons.map_outlined, size: 56, color: Color(0xFF3A3A5E)),
        const SizedBox(height: 16),
        const Text(
  ...
  Widget _buildErrorState(BuildContext context, String message) => Center(
    child: Padding(
      ...
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          const Icon(Icons.error_outline, size: 56, color: Color(0xFF8B3333)),
          const SizedBox(height: 16),
          Text(
            message,
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  if (controller.text.trim().isNotEmpty) {
                    profileBloc.add(UpdateNameEvent(controller.text.trim()));
                    Navigator.pop(dialogContext);
                  }
                },
                child: const Text(
